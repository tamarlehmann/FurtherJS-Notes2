...
console.log("5. Has a method that will return a string of HTML with 2 notes that represents the note list model.");
...
console.log("6. Has a method that will return a string of HTML with no notes that represents the note list model.");
